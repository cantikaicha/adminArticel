...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_article'])) {
    ...
    // Insert artikel baru
    $sql = "INSERT INTO article (title, content, image_url, publish_date) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssss", $title, $content, $image_url, $publish_date);
...
<head>
    ...
    <title>Tambah Artikel - Bollyreads</title>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="../dashboard.php"
                            class="text-orange-700 font-bold">
